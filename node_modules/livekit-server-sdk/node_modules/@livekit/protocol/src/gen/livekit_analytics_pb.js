...
import { ClientInfo, ParticipantInfo, ParticipantInfo_State, ReconnectReason, Room, RoomEndReason, RTPStats, TrackInfo, VideoQuality } from "./livekit_models_pb.js";
...
export const WebhookInfo = /*@__PURE__*/ proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 23, name: "http_status_code", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
  ],
);
