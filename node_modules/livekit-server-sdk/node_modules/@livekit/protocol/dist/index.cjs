...
const RoomEndReason = /* @__PURE__ */ protobuf.proto3.makeEnum(
...
const SimulationRun_List_Request = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 4, name: "start_time", kind: "message", T: protobuf.Timestamp, opt: true },
    { no: 5, name: "end_time", kind: "message", T: protobuf.Timestamp, opt: true },
...
const SimulationRun_Counts = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.SimulationRun.Counts",
  [],
  { localName: "SimulationRun_Counts" }
);
const SimulationRun_Counts_Request = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "start_time", kind: "message", T: protobuf.Timestamp },
    { no: 3, name: "end_time", kind: "message", T: protobuf.Timestamp },
    { no: 4, name: "status", kind: "enum", T: protobuf.proto3.getEnumType(SimulationRun_Status), opt: true },
    { no: 5, name: "agent_name", kind: "scalar", T: 9, opt: true }
  ],
  { localName: "SimulationRun_Counts_Request" }
);
const SimulationRun_Counts_Response = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.SimulationRun.Counts.Response",
  () => [
    { no: 1, name: "buckets", kind: "message", T: SimulationRun_Counts_Bucket, repeated: true },
    { no: 2, name: "interval", kind: "message", T: protobuf.Duration }
  ],
  { localName: "SimulationRun_Counts_Response" }
);
const SimulationRun_Counts_Bucket = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.SimulationRun.Counts.Bucket",
  () => [
    { no: 1, name: "bucket_start", kind: "message", T: protobuf.Timestamp },
    {
      no: 2,
      name: "count",
      kind: "scalar",
...
const SIPTransferReason = /* @__PURE__ */ protobuf.proto3.makeEnum(
...
const TransferSIPParticipantResponse = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "status", kind: "enum", T: protobuf.proto3.getEnumType(SIPTransferStatus) },
    { no: 3, name: "reason", kind: "enum", T: protobuf.proto3.getEnumType(SIPTransferReason) },
...
const SIPTransferInfo = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 9, name: "reason", kind: "enum", T: protobuf.proto3.getEnumType(SIPTransferReason) }
  ]
);
...
const AnalyticsEvent = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 37, name: "room_end_reason", kind: "enum", T: protobuf.proto3.getEnumType(RoomEndReason) }
  ]
);
...
const WebhookEvent = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 13, name: "room_end_reason", kind: "enum", T: protobuf.proto3.getEnumType(RoomEndReason) }
  ]
);
...
exports.RoomEndReason = RoomEndReason;
...
exports.SIPTransferReason = SIPTransferReason;
...
exports.SimulationRun_Counts = SimulationRun_Counts;
exports.SimulationRun_Counts_Bucket = SimulationRun_Counts_Bucket;
exports.SimulationRun_Counts_Request = SimulationRun_Counts_Request;
exports.SimulationRun_Counts_Response = SimulationRun_Counts_Response;
...
exports.TransferSIPParticipantResponse = TransferSIPParticipantResponse;
