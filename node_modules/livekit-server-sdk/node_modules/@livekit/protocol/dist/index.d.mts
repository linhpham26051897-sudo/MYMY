import { Message, PartialMessage, proto3, FieldList, BinaryReadOptions, JsonValue, JsonReadOptions, PlainMessage, Timestamp, Duration, Struct, Any } from '@bufbuild/protobuf';
...
declare namespace livekit_agent_session_pb_d {
  export {
    livekit_agent_session_pb_d_AgentConfigUpdate as AgentConfigUpdate,
    livekit_agent_session_pb_d_AgentHandoff as AgentHandoff,
    livekit_agent_session_pb_d_AgentSessionEvent as AgentSessionEvent,
    livekit_agent_session_pb_d_AgentSessionEvent_AgentFalseInterruption as AgentSessionEvent_AgentFalseInterruption,
    livekit_agent_session_pb_d_AgentSessionEvent_AgentStateChanged as AgentSessionEvent_AgentStateChanged,
    livekit_agent_session_pb_d_AgentSessionEvent_AmdPrediction as AgentSessionEvent_AmdPrediction,
    livekit_agent_session_pb_d_AgentSessionEvent_ConversationItemAdded as AgentSessionEvent_ConversationItemAdded,
    livekit_agent_session_pb_d_AgentSessionEvent_EotPrediction as AgentSessionEvent_EotPrediction,
    livekit_agent_session_pb_d_AgentSessionEvent_Error as AgentSessionEvent_Error,
    livekit_agent_session_pb_d_AgentSessionEvent_FunctionToolsExecuted as AgentSessionEvent_FunctionToolsExecuted,
    livekit_agent_session_pb_d_AgentSessionEvent_FunctionToolsStarted as AgentSessionEvent_FunctionToolsStarted,
    livekit_agent_session_pb_d_AgentSessionEvent_OverlappingSpeech as AgentSessionEvent_OverlappingSpeech,
    livekit_agent_session_pb_d_AgentSessionEvent_SessionUsageUpdated as AgentSessionEvent_SessionUsageUpdated,
    livekit_agent_session_pb_d_AgentSessionEvent_ToolExecutionUpdated as AgentSessionEvent_ToolExecutionUpdated,
    livekit_agent_session_pb_d_AgentSessionEvent_ToolExecutionUpdated_CallUpdated as AgentSessionEvent_ToolExecutionUpdated_CallUpdated,
    livekit_agent_session_pb_d_AgentSessionEvent_ToolExecutionUpdated_Ended as AgentSessionEvent_ToolExecutionUpdated_Ended,
    livekit_agent_session_pb_d_AgentSessionEvent_ToolExecutionUpdated_ReplyUpdated as AgentSessionEvent_ToolExecutionUpdated_ReplyUpdated,
    livekit_agent_session_pb_d_AgentSessionEvent_ToolExecutionUpdated_Started as AgentSessionEvent_ToolExecutionUpdated_Started,
    livekit_agent_session_pb_d_AgentSessionEvent_UserInputTranscribed as AgentSessionEvent_UserInputTranscribed,
    livekit_agent_session_pb_d_AgentSessionEvent_UserStateChanged as AgentSessionEvent_UserStateChanged,
    livekit_agent_session_pb_d_AgentSessionMessage as AgentSessionMessage,
    livekit_agent_session_pb_d_AgentSessionMessage_ConsoleIO as AgentSessionMessage_ConsoleIO,
    livekit_agent_session_pb_d_AgentSessionMessage_ConsoleIO_AudioFrame as AgentSessionMessage_ConsoleIO_AudioFrame,
    livekit_agent_session_pb_d_AgentSessionMessage_ConsoleIO_AudioPlaybackClear as AgentSessionMessage_ConsoleIO_AudioPlaybackClear,
    livekit_agent_session_pb_d_AgentSessionMessage_ConsoleIO_AudioPlaybackFinished as AgentSessionMessage_ConsoleIO_AudioPlaybackFinished,
    livekit_agent_session_pb_d_AgentSessionMessage_ConsoleIO_AudioPlaybackFlush as AgentSessionMessage_ConsoleIO_AudioPlaybackFlush,
    livekit_agent_session_pb_d_AgentSessionUsage as AgentSessionUsage,
    livekit_agent_session_pb_d_AgentState as AgentState,
    livekit_agent_session_pb_d_AmdCategory as AmdCategory,
    livekit_agent_session_pb_d_ChatContext as ChatContext,
    livekit_agent_session_pb_d_ChatContext_ChatItem as ChatContext_ChatItem,
    ChatMessage$1 as ChatMessage,
    livekit_agent_session_pb_d_ChatMessage_ChatContent as ChatMessage_ChatContent,
    livekit_agent_session_pb_d_ChatRole as ChatRole,
    livekit_agent_session_pb_d_DebugMessage as DebugMessage,
    livekit_agent_session_pb_d_EotModelUsage as EotModelUsage,
    livekit_agent_session_pb_d_FunctionCall as FunctionCall,
    livekit_agent_session_pb_d_FunctionCallOutput as FunctionCallOutput,
    livekit_agent_session_pb_d_InterruptionModelUsage as InterruptionModelUsage,
    livekit_agent_session_pb_d_LLMModelUsage as LLMModelUsage,
    livekit_agent_session_pb_d_MetricsReport as MetricsReport,
    livekit_agent_session_pb_d_ModelUsage as ModelUsage,
    livekit_agent_session_pb_d_STTModelUsage as STTModelUsage,
    livekit_agent_session_pb_d_SessionRequest as SessionRequest,
    livekit_agent_session_pb_d_SessionRequest_FinalizeSimulation as SessionRequest_FinalizeSimulation,
    livekit_agent_session_pb_d_SessionRequest_GetAgentInfo as SessionRequest_GetAgentInfo,
    livekit_agent_session_pb_d_SessionRequest_GetChatHistory as SessionRequest_GetChatHistory,
    livekit_agent_session_pb_d_SessionRequest_GetFrameworkInfo as SessionRequest_GetFrameworkInfo,
    livekit_agent_session_pb_d_SessionRequest_GetRTCStats as SessionRequest_GetRTCStats,
    livekit_agent_session_pb_d_SessionRequest_GetSessionState as SessionRequest_GetSessionState,
    livekit_agent_session_pb_d_SessionRequest_GetSessionUsage as SessionRequest_GetSessionUsage,
    livekit_agent_session_pb_d_SessionRequest_Ping as SessionRequest_Ping,
    livekit_agent_session_pb_d_SessionRequest_RunInput as SessionRequest_RunInput,
    livekit_agent_session_pb_d_SessionRequest_UpdateIO as SessionRequest_UpdateIO,
    livekit_agent_session_pb_d_SessionRequest_UpdateIO_Input as SessionRequest_UpdateIO_Input,
    livekit_agent_session_pb_d_SessionRequest_UpdateIO_Output as SessionRequest_UpdateIO_Output,
    livekit_agent_session_pb_d_SessionResponse as SessionResponse,
    livekit_agent_session_pb_d_SessionResponse_FinalizeSimulationResponse as SessionResponse_FinalizeSimulationResponse,
    livekit_agent_session_pb_d_SessionResponse_FinalizeSimulationResponse_SimulationVerdict as SessionResponse_FinalizeSimulationResponse_SimulationVerdict,
    livekit_agent_session_pb_d_SessionResponse_GetAgentInfoResponse as SessionResponse_GetAgentInfoResponse,
    livekit_agent_session_pb_d_SessionResponse_GetChatHistoryResponse as SessionResponse_GetChatHistoryResponse,
    livekit_agent_session_pb_d_SessionResponse_GetFrameworkInfoResponse as SessionResponse_GetFrameworkInfoResponse,
    livekit_agent_session_pb_d_SessionResponse_GetRTCStatsResponse as SessionResponse_GetRTCStatsResponse,
    livekit_agent_session_pb_d_SessionResponse_GetSessionStateResponse as SessionResponse_GetSessionStateResponse,
    livekit_agent_session_pb_d_SessionResponse_GetSessionUsageResponse as SessionResponse_GetSessionUsageResponse,
    livekit_agent_session_pb_d_SessionResponse_Pong as SessionResponse_Pong,
    livekit_agent_session_pb_d_SessionResponse_RunInputResponse as SessionResponse_RunInputResponse,
    livekit_agent_session_pb_d_SessionResponse_UpdateIOResponse as SessionResponse_UpdateIOResponse,
    livekit_agent_session_pb_d_TTSModelUsage as TTSModelUsage,
    livekit_agent_session_pb_d_TimedString as TimedString,
    livekit_agent_session_pb_d_ToolCallStatus as ToolCallStatus,
    livekit_agent_session_pb_d_ToolReplyStatus as ToolReplyStatus,
    livekit_agent_session_pb_d_UserState as UserState,
  };
}
...
declare namespace livekit_agent_inference_pb_d {
  export {
    livekit_agent_inference_pb_d_AudioEncoding as AudioEncoding,
    livekit_agent_inference_pb_d_BufferStart as BufferStart,
    livekit_agent_inference_pb_d_BufferStop as BufferStop,
    livekit_agent_inference_pb_d_ClientMessage as ClientMessage,
    livekit_agent_inference_pb_d_EotInferenceRequest as EotInferenceRequest,
    livekit_agent_inference_pb_d_EotInferenceResponse as EotInferenceResponse,
    livekit_agent_inference_pb_d_EotInputChatContext as EotInputChatContext,
    livekit_agent_inference_pb_d_EotPrediction as EotPrediction,
    livekit_agent_inference_pb_d_EotPrediction_EotBackend as EotPrediction_EotBackend,
    livekit_agent_inference_pb_d_EotSettings as EotSettings,
    livekit_agent_inference_pb_d_InferenceError as InferenceError,
    livekit_agent_inference_pb_d_InferenceRequest as InferenceRequest,
    livekit_agent_inference_pb_d_InferenceResponse as InferenceResponse,
    livekit_agent_inference_pb_d_InferenceStart as InferenceStart,
    livekit_agent_inference_pb_d_InferenceStarted as InferenceStarted,
    livekit_agent_inference_pb_d_InferenceStats as InferenceStats,
    livekit_agent_inference_pb_d_InferenceStop as InferenceStop,
    livekit_agent_inference_pb_d_InferenceStopped as InferenceStopped,
    livekit_agent_inference_pb_d_InputAudio as InputAudio,
    livekit_agent_inference_pb_d_InterruptionInferenceRequest as InterruptionInferenceRequest,
    livekit_agent_inference_pb_d_InterruptionInferenceResponse as InterruptionInferenceResponse,
    livekit_agent_inference_pb_d_InterruptionPrediction as InterruptionPrediction,
    livekit_agent_inference_pb_d_InterruptionSettings as InterruptionSettings,
    ServerMessage$1 as ServerMessage,
    livekit_agent_inference_pb_d_SessionClose as SessionClose,
    livekit_agent_inference_pb_d_SessionClosed as SessionClosed,
    livekit_agent_inference_pb_d_SessionCreate as SessionCreate,
    livekit_agent_inference_pb_d_SessionCreated as SessionCreated,
    livekit_agent_inference_pb_d_SessionFlush as SessionFlush,
...
declare namespace livekit_agent_text_pb_d {
  export {
    livekit_agent_text_pb_d_AgentSessionState as AgentSessionState,
    livekit_agent_text_pb_d_TextMessageComplete as TextMessageComplete,
    livekit_agent_text_pb_d_TextMessageError as TextMessageError,
    livekit_agent_text_pb_d_TextMessageErrorCode as TextMessageErrorCode,
    livekit_agent_text_pb_d_TextMessageRequest as TextMessageRequest,
    livekit_agent_text_pb_d_TextMessageResponse as TextMessageResponse,
  };
}
...
declare namespace livekit_agent_dev_pb_d {
  export {
    livekit_agent_dev_pb_d_AgentDevMessage as AgentDevMessage,
    livekit_agent_dev_pb_d_GetRunningAgentJobsRequest as GetRunningAgentJobsRequest,
    livekit_agent_dev_pb_d_GetRunningAgentJobsResponse as GetRunningAgentJobsResponse,
    livekit_agent_dev_pb_d_RunningAgentJobInfo as RunningAgentJobInfo,
    ServerInfo$1 as ServerInfo,
  };
}
 ...
 *
 * @generated from enum livekit.RoomEndReason
 */
declare enum RoomEndReason {
  /**
   * @generated from enum value: ROOM_END_UNKNOWN = 0;
   */
  ROOM_END_UNKNOWN = 0,
   ...
   * RoomService.DeleteRoom was called
   *
   * @generated from enum value: ROOM_END_API_DELETE = 1;
   */
   ...
   *
   * @generated from enum value: ROOM_END_IDLE_TIMEOUT = 2;
   */
   ...
   * the server instance is shutting down
   *
   * @generated from enum value: ROOM_END_SERVER_SHUTDOWN = 3;
   */
   ...
   *
   * @generated from enum value: ROOM_END_SUPERSEDED = 4;
   */
   ...
   *
   * @generated from enum value: ROOM_END_OPEN_FAILED = 5;
   */
...
declare class SimulationRun_JobMetrics extends Message<SimulationRun_JobMetrics> {
   ...
   *
   * judged {0, 0.5, 1} per agent turn; job = mean
   *
   * @generated from field: optional float conciseness = 14;
   */
  conciseness?: number;
   ...
   *
   * @generated from field: optional bool unnecessary_tool_calls = 15;
   */
  unnecessaryToolCalls?: boolean;

  /**
   * @generated from field: optional bool information_loss = 16;
   */
  informationLoss?: boolean;

  /**
   * @generated from field: optional bool redundant_statements = 17;
   */
  redundantStatements?: boolean;

  /**
   * @generated from field: optional bool poor_question_quality = 18;
   */
  poorQuestionQuality?: boolean;

  /**
   * 0-1, derived from the flags above
   *
   * @generated from field: optional float conversation_progression = 19;
   */
...
declare class SimulationRun_JobMetrics_STT extends Message<SimulationRun_JobMetrics_STT> {
  /**
   * needs the RemoteSession; word_errors / words
   *
  ...
  /**
   * needs the RemoteSession; char_errors / chars
   *
  ...
  /**
   * needs the RemoteSession; agent-reported STT/endpointing delay
   *
   * @generated from field: optional uint32 stt_delay_ms = 8;
   */
  sttDelayMs?: number;
   ...
   * recognized / uttered
   *
   * @generated from field: optional float entity_recognition = 11;
   */
  entityRecognition?: number;

  /**
   * @generated from field: optional uint32 entities_uttered = 12;
   */
  entitiesUttered?: number;

  /**
   * @generated from field: optional uint32 entities_recognized = 13;
   */
   ...
   *
   * acquired_recognized / acquired_uttered
   *
   * @generated from field: optional float entity_recall = 14;
   */
  entityRecall?: number;

  /**
   * @generated from field: optional uint32 entities_acquired_uttered = 15;
   */
  entitiesAcquiredUttered?: number;

  /**
   * @generated from field: optional uint32 entities_acquired_recognized = 16;
   */
  entitiesAcquiredRecognized?: number;
...
declare class SimulationRun_JobMetrics_LLM extends Message<SimulationRun_JobMetrics_LLM> {
  /**
   * needs the RemoteSession; time to first token
   *
...
declare class SimulationRun_JobMetrics_TTS extends Message<SimulationRun_JobMetrics_TTS> {
   ...
   * recognized / uttered
   *
   * @generated from field: optional float entity_recognition = 14;
   */
  entityRecognition?: number;

  /**
   * @generated from field: optional uint32 entities_uttered = 15;
   */
  entitiesUttered?: number;

  /**
   * @generated from field: optional uint32 entities_recognized = 16;
   */
  entitiesRecognized?: number;
   ...
   * acquired_recognized / acquired_uttered
   *
   * @generated from field: optional float entity_recall = 17;
   */
  entityRecall?: number;

  /**
   * @generated from field: optional uint32 entities_acquired_uttered = 18;
   */
  entitiesAcquiredUttered?: number;

  /**
   * @generated from field: optional uint32 entities_acquired_recognized = 19;
   */
  entitiesAcquiredRecognized?: number;
...
declare class SimulationRun_JobMetrics_Conversation extends Message<SimulationRun_JobMetrics_Conversation> {
   ...
   *
   * @generated from field: optional int32 heard_e2e_latency_p50_ms = 2;
   */
  heardE2eLatencyP50Ms?: number;

  /**
   * @generated from field: optional int32 heard_e2e_latency_p95_ms = 3;
   */
  heardE2eLatencyP95Ms?: number;

  /**
   * @generated from field: optional int32 heard_e2e_latency_p99_ms = 4;
   */
  heardE2eLatencyP99Ms?: number;

  /**
   * agent audio continuing past a barge-in
   *
   * @generated from field: optional uint32 time_to_yield_ms = 5;
   */
  timeToYieldMs?: number;
   ...
   *
   * @generated from field: optional uint32 unanswered_turns = 12;
   */
  ...
  /**
   * needs the RemoteSession; the agent's own claim
   *
   * @generated from field: optional uint32 e2e_latency_ms = 15;
   */
  e2eLatencyMs?: number;
...
declare class SimulationRun_JobMetrics_Turn extends Message<SimulationRun_JobMetrics_Turn> {
   ...
   * needs the RemoteSession
   *
   * @generated from field: optional uint32 stt_delay_ms = 5;
   */
  sttDelayMs?: number;
   ...
   * needs the RemoteSession
   *
   * @generated from field: optional uint32 llm_ttft_ms = 6;
   */
  llmTtftMs?: number;
   ...
   * needs the RemoteSession
   *
   * @generated from field: optional uint32 llm_ttfs_ms = 7;
   */
  llmTtfsMs?: number;
   ...
   * needs the RemoteSession
   *
   * @generated from field: optional float llm_tps = 8;
   */
  llmTps?: number;
   ...
   * needs the RemoteSession
   *
   * @generated from field: optional uint32 tts_ttfb_ms = 9;
   */
  ttsTtfbMs?: number;
   ...
   * needs the RemoteSession
   *
   * @generated from field: optional uint32 e2e_latency_ms = 10;
   */
  e2eLatencyMs?: number;

  /**
   * @generated from field: optional int32 heard_e2e_latency_ms = 11;
   */
  heardE2eLatencyMs?: number;

  /**
   * @generated from field: optional uint32 time_to_yield_ms = 12;
   */
  timeToYieldMs?: number;

  /**
   * @generated from field: optional float turn_taking_score = 13;
   */
  turnTakingScore?: number;

  /**
   * needs the text judge
   *
   * @generated from field: optional float conciseness = 14;
   */
  conciseness?: number;
  ...
  /**
   * @generated from field: optional bool eot_misprediction = 15;
   */
  eotMisprediction?: boolean;

  /**
   * @generated from field: optional bool awkward_silence = 16;
   */
  awkwardSilence?: boolean;

  /**
   * @generated from field: optional bool unanswered = 17;
   */
  unanswered?: boolean;
...
declare class SimulationRun_RunMetrics extends Message<SimulationRun_RunMetrics> {
   ...
   *
   * @generated from field: optional float conciseness = 8;
   */
  conciseness?: number;

  /**
   * @generated from field: optional float conversation_progression = 9;
   */
  conversationProgression?: number;
...
declare class SimulationRun_Create_Request extends Message<SimulationRun_Create_Request> {
   ...
   *
   * @generated from field: bool background_noise = 10;
   */
  backgroundNoise: boolean;

  /**
   * @generated from field: bool low_quality_microphone = 11;
   */
  lowQualityMicrophone: boolean;

  /**
   * @generated from field: bool packet_loss = 12;
   */
  packetLoss: boolean;
...
declare class SimulationRun_List_Request extends Message<SimulationRun_List_Request> {
   ...
   *
   * @generated from field: optional string agent_name = 6;
   */
  agentName?: string;
 ...
 *
 * @generated from message livekit.SimulationRun.Counts
 */
declare class SimulationRun_Counts extends Message<SimulationRun_Counts> {
  constructor(data?: PartialMessage<SimulationRun_Counts>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.SimulationRun.Counts";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): SimulationRun_Counts;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): SimulationRun_Counts;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): SimulationRun_Counts;

  static equals(a: SimulationRun_Counts | PlainMessage<SimulationRun_Counts> | undefined, b: SimulationRun_Counts | PlainMessage<SimulationRun_Counts> | undefined): boolean;
}

/**
 * @generated from message livekit.SimulationRun.Counts.Request
 */
declare class SimulationRun_Counts_Request extends Message<SimulationRun_Counts_Request> {
  /**
   * @generated from field: string project_id = 1;
   */
  projectId: string;
   ...
   *
   * @generated from field: optional livekit.SimulationRun.Status status = 4;
   */
  status?: SimulationRun_Status;
  ...
  constructor(data?: PartialMessage<SimulationRun_Counts_Request>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.SimulationRun.Counts.Request";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): SimulationRun_Counts_Request;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): SimulationRun_Counts_Request;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): SimulationRun_Counts_Request;

  static equals(a: SimulationRun_Counts_Request | PlainMessage<SimulationRun_Counts_Request> | undefined, b: SimulationRun_Counts_Request | PlainMessage<SimulationRun_Counts_Request> | undefined): boolean;
}

/**
 * @generated from message livekit.SimulationRun.Counts.Response
 */
declare class SimulationRun_Counts_Response extends Message<SimulationRun_Counts_Response> {
  /**
   ...
   *
   * @generated from field: repeated livekit.SimulationRun.Counts.Bucket buckets = 1;
   */
  buckets: SimulationRun_Counts_Bucket[];
  ...
  constructor(data?: PartialMessage<SimulationRun_Counts_Response>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.SimulationRun.Counts.Response";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): SimulationRun_Counts_Response;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): SimulationRun_Counts_Response;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): SimulationRun_Counts_Response;

  static equals(a: SimulationRun_Counts_Response | PlainMessage<SimulationRun_Counts_Response> | undefined, b: SimulationRun_Counts_Response | PlainMessage<SimulationRun_Counts_Response> | undefined): boolean;
}

/**
 * @generated from message livekit.SimulationRun.Counts.Bucket
 */
declare class SimulationRun_Counts_Bucket extends Message<SimulationRun_Counts_Bucket> {
  /**
  ...
  constructor(data?: PartialMessage<SimulationRun_Counts_Bucket>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.SimulationRun.Counts.Bucket";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): SimulationRun_Counts_Bucket;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): SimulationRun_Counts_Bucket;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): SimulationRun_Counts_Bucket;

  static equals(a: SimulationRun_Counts_Bucket | PlainMessage<SimulationRun_Counts_Bucket> | undefined, b: SimulationRun_Counts_Bucket | PlainMessage<SimulationRun_Counts_Bucket> | undefined): boolean;
}
...
declare enum EncodingOptionsPreset {
   ...
   *
   * @generated from enum value: PASSTHROUGH = 8;
   */
  PASSTHROUGH = 8,
}
...
/**
 * @generated from enum livekit.SIPTransferReason
 */
declare enum SIPTransferReason {
  /**
   * No reason reported
   *
   * @generated from enum value: STR_UNSPECIFIED = 0;
   */
  STR_UNSPECIFIED = 0,
   ...
   *
   * @generated from enum value: STR_COMPLETED = 1;
   */
  STR_COMPLETED = 1,
   ...
   *
   * @generated from enum value: STR_CALL_ENDED = 2;
   */
  STR_CALL_ENDED = 2,
   ...
   *
   * @generated from enum value: STR_REJECTED = 3;
   */
  STR_REJECTED = 3,
   ...
   *
   * @generated from enum value: STR_RINGING_TIMEOUT = 4;
   */
   ...
   *
   * @generated from enum value: STR_SUBSCRIPTION_TERMINATED = 5;
   */
   ...
   *
   * @generated from enum value: STR_CANCELED = 6;
   */
  STR_CANCELED = 6,
}
...
declare class CreateSIPParticipantRequest extends Message<CreateSIPParticipantRequest> {
   ...
   *
   * @generated from field: string to_user_override = 27;
   */
  toUserOverride: string;
...
/**
 * @generated from message livekit.TransferSIPParticipantResponse
 */
declare class TransferSIPParticipantResponse extends Message<TransferSIPParticipantResponse> {
  /**
  ...
  /**
   * @generated from field: livekit.SIPTransferStatus status = 2;
   */
  status: SIPTransferStatus;

  /**
   * @generated from field: livekit.SIPTransferReason reason = 3;
   */
   ...
   *
   * @generated from field: livekit.SIPStatus sip_status = 4;
   */
  sipStatus?: SIPStatus;

  constructor(data?: PartialMessage<TransferSIPParticipantResponse>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.TransferSIPParticipantResponse";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): TransferSIPParticipantResponse;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): TransferSIPParticipantResponse;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): TransferSIPParticipantResponse;

  static equals(a: TransferSIPParticipantResponse | PlainMessage<TransferSIPParticipantResponse> | undefined, b: TransferSIPParticipantResponse | PlainMessage<TransferSIPParticipantResponse> | undefined): boolean;
}
...
declare class SIPTransferInfo extends Message<SIPTransferInfo> {
  ...
  /**
   * @generated from field: livekit.SIPTransferReason reason = 9;
   */
  reason: SIPTransferReason;
...
declare class AnalyticsEvent extends Message<AnalyticsEvent> {
  ...
  /**
   * @generated from field: livekit.RoomEndReason room_end_reason = 37;
   */
...
declare class WebhookInfo extends Message<WebhookInfo> {
   ...
   *
   * @generated from field: int32 http_status_code = 23;
   */
...
declare class SyncState extends Message<SyncState> {
  ...
  /**
   * @generated from field: livekit.UpdateDataSubscription data_subscription = 9;
   */
  dataSubscription?: UpdateDataSubscription;
...
declare class WebhookEvent extends Message<WebhookEvent> {
   ...
   *
   * @generated from field: livekit.Job job = 12;
   */
  job?: Job;
   ...
   *
   * @generated from field: livekit.RoomEndReason room_end_reason = 13;
   */
  roomEndReason: RoomEndReason;
